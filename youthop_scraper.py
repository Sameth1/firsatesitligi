...
def build_record(base, detail_url, category_slug, apply_link=None):
    ...
    if not base.get("application_url_verified_at"):
        rec["admin_note"] = "[uyarı] doğrulanmış doğrudan başvuru adımı bulunamadı"
    return rec
