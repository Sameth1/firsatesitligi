-- Yalnız doğrulanmış, doğrudan başvuru adımı olan fırsatları kullanıcıya göster.
-- Bilgi/koşul sayfaları veritabanında korunur fakat eşleşme sonuçlarına girmez.
...
comment on function public.match_opportunities(text, text, text, integer, text, text, text, text)
is 'Returns only active opportunities with a verified direct application action.';
